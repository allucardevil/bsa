                        ...
                        <div class="textBlog">
                            ...
                            <div class="textBlogdetails">
							   ...
							   ?>
								...
								<?php echo anchor('team/edit/' . $row->wc_lang . '/' . $row->wc_type . '/' . $row->wc_category . '/' . $row->wc_sub_category . '/' . $row->wc_id . '/', 'Edit', array('class' => 'buttonPro')); ?> 
                                
                               
                                
                                &nbsp; &nbsp;
								
								<?php echo anchor('team/delete/' . $row->wc_id . '/', 'Delete', array('class' => 'buttonPro')); ?>
...
<span class='st_email' displayText='Email'></span>
							...
							elseif($row->wc_title == 'Gapura Hospitality Service')
							{
								echo '<h3>Get Inquiry for this service </h3>';
								echo '<div class="dash-line"></div>';
								if($this->uri->segment(6) == NULL)
								{
									$this->view('team/hospitality-service-form');
								}else
								if($this->uri->segment(6) == 'last')
								{
										$this->view('team/hospitality-service-form-last');
								}else
								{
									if($hs_type == 'Departure')
									{
										$this->view('team/hospitality-service-form-departure');
									}
									if($hs_type == 'Arrival')
									{
										$this->view('team/hospitality-service-form-arrival');
									}
