				...
				<div class="sidebar last">
                    ...
                    <h3>Gallery</h3>
                        <div class="slides_container">
                            ...
                            <div>
                                <ul>
                                    <li><img src="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/images/rPortofolio2.jpg" alt=""></li>
                                    <li><p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper 
                                    suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p></li>
                                </ul>
                            </div>
                            <div>
                                <ul>
                                    <li><img src="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/images/rPortofolio3.jpg" alt=""></li>
                                    <li><p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper 
                                    suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p></li>
                                </ul>
                            </div>
