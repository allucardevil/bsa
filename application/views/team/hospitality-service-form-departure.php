 ...
 <h2>Departure (Part 2 of 3)</h2>
    ...
    <br/>
	 <label for="res-dep-pickup">Local Address:</label>
      <textarea name="hs_local_address" id="hs_local_address" class="form-textarea" cols="50" rows="3"></textarea>
      ...
      <label for="res-dep-date">Departure date:</label>
      <input type="text" class="form-text datepicker" id="hs_date" name="hs_date" value="" /> <h6>date format (dd-mm-yyyy)</h6>
	  <label for="res-dep-date">Departure time: (hh:mm AM/PM) Local Time</label>
